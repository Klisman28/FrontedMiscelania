                        ...
                        {productList.map((product, index) => (
                            ...
                            >
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1 sm:gap-4">
                                    ...
                                    <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center shrink-0 border-t sm:border-t-0 pt-2 sm:pt-0 mt-1 sm:mt-0 border-gray-100 dark:border-gray-700">
                                        ...
                                        <div className="text-right">
                                            <div className={`text-xs font-medium px-2 py-0.5 rounded-md ${product.stock > 10
