    ...
    return (
        <div className="group bg-white border border-slate-200/80 rounded-2xl shadow-sm hover:shadow-md hover:border-indigo-200/60 transition-all duration-300 p-6 h-full flex flex-col">
            ...
            <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400 to-teal-600 flex items-center justify-center shadow-md shadow-emerald-500/20 group-hover:scale-110 transition-transform duration-300">
                    <HiOutlineClipboardList className="w-5 h-5 text-white" />
                </div>
                <div className="min-w-0">
                    <h5 className="text-base font-bold text-slate-900 leading-tight">Boleta</h5>
                    <p className="text-[11px] text-slate-400 mt-0.5 truncate">Serie y número inicial</p>
                </div>
            </div>

            {/* Divider */}
            <div className="h-px bg-gradient-to-r from-emerald-200/60 via-transparent to-transparent mb-5"></div>
